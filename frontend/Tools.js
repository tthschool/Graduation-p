export  const tools = [
    ...
    },
    {
      ...
      function: {
        name: "getAllBudget",
        description:
          "Returns the budget data for all months from the database, current month when current_month field is true , and you can based on that data to provide user sum of individual moths ,and the The official currency is the Japanese yen",
        parameters: {
          type: "object",
          properties: {
            period: {
